<!--
CACHED SNAPSHOT of the real customer_support_copilot/README.md, fetched
...
repo over time -- re-run the fetch in indexing.py's fetch_project_readme
whenever you want this refreshed, or just delete this file and let the
live fetch run (it only falls back to this file when the network call
fails).
-->
