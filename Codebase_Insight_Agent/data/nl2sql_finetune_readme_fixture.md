<!--
CACHED SNAPSHOT of the real nl2sql_finetune/README.md, fetched
...
`Python` `PyTorch` `Transformers` `TRL (SFTTrainer)` `PEFT/QLoRA` `SQLite`
...
- [Results](#results)
- [Why this took two iterations](#why-this-took-two-iterations)
