"""Citation parsing + verification -- same approach as impl_vanilla:
re-check the model's [N] tags against what was actually retrieved, rather
than trusting the generated citations at face value.
"""
